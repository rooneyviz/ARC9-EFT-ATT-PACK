...
ARC9EFT.Glock_AnimsHook = function(swep, anim)
    ...
    if elements["eft_mag_g17_sgmt_50"] then ending = 3
    ...
    elseif elements["eft_mag_g17_std_17"] or elements["eft_mag_g19x_std_21"] or elements["eft_mag_slickers"] then ending = 0
