...
SWEP.Description = [[The SR15 is an AR-pattern rifle by KAC with improved reliability and features including ambidextrous magazine release,bolt catch, and fire selector, adapted from the SR25 designed by eugene stoner,chambered in 5.56x45 rounds.]]
...
SWEP.MalfunctionMeanShotsToFail = 1.6 * 450
...
SWEP.AttachmentElements = {
    ...
    ["eft_ar15_tg_kac"]    = { Bodygroups = { {7, 5} } }, 
