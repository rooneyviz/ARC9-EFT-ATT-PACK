...
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_cancan.mdl"
...
SWEP.PhysBulletMuzzleVelocity = 130 /0.0254
SWEP.RangeMin = 10
...
SWEP.Firemodes = {
    { Mode = 1, PoseParam = 1,PrintName = "Bolt-action"  }
}
SWEP.SlamFire = true
