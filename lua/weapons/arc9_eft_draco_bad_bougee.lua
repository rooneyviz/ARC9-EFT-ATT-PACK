...
SWEP.PrintName = "AKSBR"
SWEP.Class = ARC9:GetPhrase("eft_class_weapon_ar")
SWEP.Trivia = {
    [ARC9:GetPhrase("eft_trivia_manuf") .. "1"] = "Gun Kitchen Manufacturing Company",
...
SWEP.Description = [[GKMC AKSBR assault rifle 7.62x39mm, a shortened versionof the AK system manufactured by GKMC. The main difference from the standard AK: The barrel is very short, which significantly improves the compactness of the weapon.]]
...
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_draco.mdl"
...
--          Spread
SWEP.Spread = 2.9045 * ARC9.MOAToAcc
