...
SWEP.PrintName = "Glock 17 TTI"

SWEP.Class = ARC9:GetPhrase("eft_class_weapon_pist")
SWEP.Trivia = {
    [ARC9:GetPhrase("eft_trivia_manuf") .. "1"] = "Taran Tactical Innovations",
    [ARC9:GetPhrase("eft_trivia_cal") .. "2"] = "9x19mm Parabellum",
    [ARC9:GetPhrase("eft_trivia_act") .. "3"] = "Recoil",
    [ARC9:GetPhrase("eft_trivia_country") .. "4"] = "United states",
...
SWEP.Description = [[A Glock 17 modified by Taran Tactical innovations with grip reduction,reduced finger groves, cut trigger guard, large magwell,stippling,accelerator cuts, among other modifications.]]
...
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_glock_jw2.mdl"
...
SWEP.AttachmentElements = {
    ["eft_barrel_g17_aw"]    = { Bodygroups = { {2, 4} } },
    ["eft_barrel_g17_comp"]    = { Bodygroups = { {2, 2} } },
    ["eft_barrel_g17_dd_thr"]    = { Bodygroups = { {2, 3} } },
    ["eft_barrel_g17_sai"]    = { Bodygroups = { {2, 5} } },
    ["eft_barrel_g17_std"]    = { Bodygroups = { {2, 1} } },

    ["eft_rec_g17_aw"]    = { Bodygroups = { {1, 5} } },
    ["eft_rec_g17_aw_c"]    = { Bodygroups = { {1, 6} } },
    ["eft_rec_g17_mos"]    = { Bodygroups = { {1, 9} } },
    ["eft_rec_g17_motocut"]    = { Bodygroups = { {1, 8} } },
    ["eft_rec_g17_ps9"]    = { Bodygroups = { {1, 4} } },
    ["eft_rec_g17_std"]    = { Bodygroups = { {1, 1} } },
    ["eft_rec_g17_vipercut"]    = { Bodygroups = { {1, 7} } },
    ["eft_rec_g17_zt_hex"]    = { Bodygroups = { {1, 3} } },
    ["eft_rec_g17_zt_spartan"]    = { Bodygroups = { {1, 2} } },
