...
SWEP.PrintName = "Noveske N4"
SWEP.Class = ARC9:GetPhrase("eft_class_weapon_ar")
SWEP.Trivia = {
    [ARC9:GetPhrase("eft_trivia_manuf") .. "1"] = "Noveske Rifleworks",
    [ARC9:GetPhrase("eft_trivia_cal") .. "2"] = "5.56×45mm Blackout",
...
SWEP.Description = [[The Noveske N4 rifle(Gen. 3) is designed for performance with an oversized flared magazine well for swift reloads,integrated oversized trigger guard,based on the AR15 platform.]]
...
SWEP.Attachments = {
    {
        ...
        SubAttachments = {
            ...
            },
            {
                ...
                SubAttachments = {
                    {},
                    { Installed = "eft_frontsight_mbus_love" },
                    {},
                    {},
                    {},
    ...
    },
{
        ...
        Integral = true,
        Installed = "eft_ar15_fireselector_Colt",
        Bone = "weapon",
        Pos = Vector(1, 11, -1.5),
        Ang = Angle(0, 0, 0),
    },
