...
SWEP.PrintName = "Krinkov"
SWEP.Class = ARC9:GetPhrase("eft_class_weapon_ar")
SWEP.Trivia = {
    [ARC9:GetPhrase("eft_trivia_manuf") .. "1"] = "Custom made",
    [ARC9:GetPhrase("eft_trivia_cal") .. "2"] = "7.62x39mm",
    [ARC9:GetPhrase("eft_trivia_act") .. "3"] = ARC9:GetPhrase("eft_trivia_act_gas"),
    [ARC9:GetPhrase("eft_trivia_country") .. "4"] = "Pakistan",
    [ARC9:GetPhrase("eft_trivia_year") .. "5"] = "1990",
}

SWEP.Description = [[A custom pakistani gun made in the dara adam khel region with various AK pattern parts.]]
...
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_dak.mdl"
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Installed = "eft_mag_ak_6l10_762_30"
    },    
    {
        PrintName = "Gas tube",
        ...
        SubAttachments = {
            {
                Installed = "eft_aksu_seperate_hg",
SubAttachments = {
            {
                Installed = "eft_aksu_Lhg_dak",
		},
{
                Installed = "eft_aksu_gc_dak",
