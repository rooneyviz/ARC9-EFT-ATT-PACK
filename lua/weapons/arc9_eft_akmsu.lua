...
SWEP.Trivia = {
    ...
    [ARC9:GetPhrase("eft_trivia_year") .. "5"] = "1979-1985"
}

SWEP.Description = [[*A custom made US clone of the notable AKMSU Carbine .]]
...
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_akmsu.mdl"
