...
SWEP.Trivia = {
    ...
    [ARC9:GetPhrase("eft_trivia_year") .. "5"] = "2011" -- idk
}

SWEP.Description = [[The Q Honey Badger is an AR-pattern personal defense weapon, designed primarily for use in a suppressed configuration. It is chambered in .300 Blackout designed on the AR-15 system base. Produced by Q LLC.]]


SWEP.BarrelLength = 38
SWEP.Slot = 2
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_hbadger.mdl"
...
SWEP.StandardPresets = {
    "[INSS]"
}
...
SWEP.AttachmentElements = {
    ...
    ["eft_ar15_trigger_kac"]    = { Bodygroups = { {2, 5} } },    
    ...
    ["eft_ar15_fireselector_kac"]    = { Bodygroups = { {4, 3} } }, 

    ["eft_ar15_fireselector_stm15"]    = { Bodygroups = { {4, 3} } }, 
    ["eft_ar15_fireselector_kac"]    = { Bodygroups = { {4, 4} } }, 
